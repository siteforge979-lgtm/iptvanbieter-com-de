...
export function t(key: string, lang: LanguageCode = 'de'): string {
...
export function translateUI(key: string, lang: LanguageCode = 'de', replacements?: Record<string, string>): string {
  const parts = key.split('.');
